...
path<-"Data/20180613" #the location of all your titration files
massfile<-"20180613mass_Run1.csv" # name of your file with masses
titrationfile<-'20180613_Run1.csv'# name of the last titration file run
