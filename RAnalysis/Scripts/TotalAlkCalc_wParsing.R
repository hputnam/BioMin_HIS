...
path<-"Data/20180709" #the location of all your titration files
massfile<-"20180709mass_Run5.csv" # name of your file with masses
titrationfile<-'20180709_Run5.csv'# name of the last titration file run
