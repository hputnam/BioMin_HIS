...
path<-"Data/20180609" #the location of all your titration files
massfile<-"20180609mass_Run2.csv" # name of your file with masses
titrationfile<-'20180609_Run2.csv'# name of the last titration file run
