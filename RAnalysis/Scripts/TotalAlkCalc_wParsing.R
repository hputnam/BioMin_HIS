...
path<-"Data/20180715" #the location of all your titration files
massfile<-"20180715mass_Run2.csv" # name of your file with masses
titrationfile<-'20180715_Run2.csv'# name of the last titration file run
