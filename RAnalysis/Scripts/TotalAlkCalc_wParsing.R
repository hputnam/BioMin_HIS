...
massfile<-"20180713mass_Run2.csv" # name of your file with masses
titrationfile<-'20180713_Run2.csv'# name of the last titration file run

# Date that the data were run
date<-'20180713'
>>>>>>> 7d12cc298d3e4e9aef684a2f540b01657dce4fca
